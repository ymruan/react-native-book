...
APP_ID=hackweek MASTER_KEY=hackweekKey PARSE_DASHBOARD_ALLOW_INSECURE_HTTP=true USER1=paas USER1_PASSWORD=paasWIN SERVER_URL=http://my-cms-qa:1337/parse docker-compose up
```
